...
var startGameEl = document.querySelector(".controls-playgame");
var viewScoresEl = document.querySelector(".controls-highscores");
var leaderboardEl = document.querySelector(".scoreboard-score");
var gameboardResultEl = document.querySelector(".gameboard-result");
